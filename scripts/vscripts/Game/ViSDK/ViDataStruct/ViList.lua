...
ViList.Add = Add
ViList.Clear = Clear
ViList.Contains = Contains
ViList.Count = Count
ViList.Get = Get
ViList.Find = Find
ViList.ForEach = ForEach
ViList.IndexOf = IndexOf
ViList.LastIndexOf = LastIndexOf
ViList.Insert = Insert
ViList.Remove = Remove
ViList.Sort = Sort
